      ...
      <SceneWrap label="S1 hook">
        <Cam kf={[{ t: 0, s: 1.06 }, { t: 10, s: 1.0 }, { t: 12.4, s: 1.0 }, { t: 14.2, s: 0.94, y: 30 }]}>
          <SceneSvg>
            ...
            <SketchButton x={360} y={430} w={280} h={120} label="BUY" start={0.4} seed={2}
              fill="var(--good-soft)" fontSize={52} press={[3.1]}></SketchButton>
            <SketchButton x={360} y={590} w={280} h={120} label="SELL" start={1.1} seed={3}
            ...
            <SvgText x={1545} y={735} size={30} start={7.6} color="var(--ink-soft)">…and repeat?</SvgText>
            {/* The bigger button */}
            <Seg start={13.0}>
              {({ localTime }) => {
          ...
          <HandText x={960} y={56} size={58} align="center" font="var(--font-display)" weight={700}
            start={0.6} rotate={-1} fadeOutAt={12.4}>Markets = two buttons… right?</HandText>
        </Cam>
        <Highlight start={18.2} end={23.7} size={120}>Finance is *not just* buying and selling.</Highlight>
      </SceneWrap>
    </Sprite>
  );
}
      ...
      <SceneWrap label="S2 crypto today">
          ...
          {({ localTime }) => (
            <div style={{ position: 'absolute', inset: 0, opacity: clamp((9.8 - localTime) / 0.4, 0, 1) }}>
              <SceneSvg>
                ...
                <SvgText x={620} y={590} size={48} font="var(--font-display)" weight={700} start={1.0}>SPOT MARKET</SvgText>
                <SvgText x={620} y={646} size={30} color="var(--ink-soft)" start={1.2}>(a pool on a DEX)</SvgText>
                {/* buyer / seller */}
                ...
                <SvgText x={1450} y={520} size={30} color="var(--ink-soft)" start={6.4}>up, down, sideways…</SvgText>
              </SceneSvg>
              <HandText x={960} y={56} size={58} align="center" font="var(--font-display)" weight={700}
                start={0.4} rotate={1}>Spot Markets, crypto’s entire financial system:</HandText>
            </div>
          )}
        </Seg>
        ...
        <Seg start={10}>
          <SceneSvg>
            ...
            <SketchButton x={1130} y={500} w={250} h={104} label="HOLD" start={3.4} seed={61} fontSize={40}></SketchButton>
            <SketchButton x={1420} y={500} w={250} h={104} label="PRAY" start={4.2} seed={62} fontSize={40}></SketchButton>
            <SketchButton x={1130} y={644} w={250} h={104} label="TWEET" start={5.0} seed={63} fontSize={40}></SketchButton>
            <SketchButton x={1420} y={644} w={250} h={104} label="DUMP LATER" start={5.8} seed={64} fontSize={32}></SketchButton>
            <Sparkle cx={1690} cy={460} r={14} start={6.4}></Sparkle>
          </SceneSvg>
          <HandText x={620} y={420} size={84} align="center" font="var(--font-display)" weight={700}
            start={1.8} rotate={-2}>Now what?</HandText>
          <HandText x={1395} y={420} size={40} align="center" start={3.0} rotate={-1}
            color="var(--ink-soft)">your options:</HandText>
        </Seg>
        <Highlight start={S + 19.6} end={S + 23.7} size={130}>All crypto enables us is to Buy. Hold. *Hope.*</Highlight>
      </SceneWrap>
    </Sprite>
  );
}
        ...
        <Cam kf={[{ t: 0, s: 1 }, { t: 9.5, s: 1 }, { t: 11.5, s: 1.07, y: -20 }]}>
          <SceneSvg>
            ...
            <SvgText x={960} y={470} size={40} font="var(--font-display)" weight={700}
              color="var(--accent)" start={12.6} plate plateSeed={121}>← YIELD</SvgText>
            <SvgText x={960} y={800} size={40} font="var(--font-display)" weight={700} start={13.2}
              plate plateSeed={122}>EXPOSURE →</SvgText>
          </SceneSvg>
          <HandText x={480} y={170} size={56} align="center" font="var(--font-display)" weight={700}
            start={0.9}>ASSET HOLDERS</HandText>
          <HandText x={480} y={248} size={34} align="center" start={1.3} color="var(--ink-soft)">banks · landlords · funds · holders</HandText>
          <HandText x={1440} y={170} size={56} align="center" font="var(--font-display)" weight={700}
            start={3.9}>EXPOSURE SEEKERS</HandText>
          <HandText x={1440} y={248} size={34} align="center" start={4.3} color="var(--ink-soft)">home buyers · companies · traders</HandText>
          <HandText x={960} y={56} size={50} align="center" start={9.0} rotate={-1}
            font="var(--font-display)" weight={700}>Finance = a matching engine</HandText>
        </Cam>
        <Highlight start={S + 17.6} end={S + 23.7} size={110}>One side wants *yield.* The other wants *exposure.*</Highlight>
      </SceneWrap>
    </Sprite>
  );
}
