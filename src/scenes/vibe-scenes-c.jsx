      ...
      <SceneWrap label="S7 vibe idea">
        <SceneSvg>
          ...
          <Bubble x={110} y={530} w={470} h={170} tail="bl" start={3.4} fontSize={36}>
            “I hold this asset. I want yield.”
          </Bubble>
          {/* trader side */}
          ...
          <Bubble x={1340} y={530} w={470} h={170} tail="br" start={6.4} fontSize={36}>
            “I want exposure. Long. Short. Leveraged.”
          </Bubble>
          {/* flows */}
          <Seg start={10.8}>
            ...
            <FlowDot p0={[1440, 780]} c={[1320, 500]} p1={[1130, 410]} start={1.0} phase={0.2} r={13} color="var(--ink)" label="fee" labelSize={14}></FlowDot>
        ...
        <HandText x={960} y={372} size={78} align="center" font="var(--font-brand)" weight={900}
          start={1.1}>Vibe</HandText>
        <HandText x={960} y={56} size={50} align="center" font="var(--font-display)" weight={700}
          start={8.6} rotate={-1}>a marketplace between the two</HandText>
        <Highlight start={S + 17.6} end={S + 23.7} size={118}>*Yield* for holders. *Exposure* for traders.</Highlight>
      </SceneWrap>
    </Sprite>
  );
}
      ...
      <SceneWrap label="S8 synthetic exposure">
            ...
            <div style={{ position: 'absolute', inset: 0, opacity: clamp((6.4 - localTime) / 0.35, 0, 1) }}>
              <SceneSvg>
                ...
                <FlowDot p0={[620, 800]} c={[860, 620]} p1={[1060, 800]} start={1.2} period={1.1} once
                  r={30} color="var(--paper2)" label="DOG" labelColor="var(--ink)" labelSize={20}></FlowDot>
              ...
              <HandText x={960} y={56} size={54} align="center" font="var(--font-display)" weight={700}
                start={0.3} rotate={1}>Can’t we just… lend it out?</HandText>
        ...
        <Seg start={6.6}>
          <SceneSvg>
            ...
            <SvgText x={540} y={748} size={40} font="var(--font-display)" weight={700} start={1.4}>Token Vaults</SvgText>
            <SvgText x={540} y={790} size={26} color="var(--ink-soft)" start={1.7}>(no stablecoins needed)</SvgText>
            <SvgText x={540} y={860} size={28} color="var(--ink-soft)" start={5.4}>tokens never transfer to traders, physically</SvgText>
            <Seg start={1.6}><StickFigure x={180} y={940} pose="press" facing={1} mood="happy" start={0} scale={1.05}></StickFigure></Seg>
            <SvgText x={180} y={1015} size={28} font="var(--font-display)" weight={700} start={2.0}>HOLDER</SvgText>
            <FlowDot p0={[240, 800]} c={[360, 520]} p1={[520, 500]} start={2.2} period={1.0} once r={20}
              color="var(--paper2)" label="DOG" labelColor="var(--ink)" labelSize={15}></FlowDot>
            ...
            <SvgText x={970} y={380} size={30} color="var(--accent)" weight={700} start={6.8}>the price</SvgText>
            {/* trade screen */}
                ...
                <g>
                  <g transform={lt > 8.4 && lt < 8.9 ? 'translate(0 4)' : ''}>
                    ...
                    <text x={1345} y={745} textAnchor="middle" opacity={clamp(lt / (0.4 * ANIM), 0, 1)}
                      style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 38, fill: '#fff' }}>LONG 20x</text>
                  </g>
                  ...
                  <text x={1575} y={745} textAnchor="middle" opacity={clamp((lt - 0.3) / (0.4 * ANIM), 0, 1)}
                    style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 38, fill: 'var(--ink)' }}>SHORT 20x</text>
                </g>
              )}
            </Seg>
            <Seg start={7.4}><StickFigure x={1830} y={940} pose="press" facing={-1} start={0} scale={1.05}></StickFigure></Seg>
            <SvgText x={1830} y={1015} size={28} font="var(--font-display)" weight={700} start={7.8}>TRADER</SvgText>
            ...
            <SvgText x={290} y={380} size={28} font="var(--font-display)" weight={700} start={7.2}>SOLVER</SvgText>
            <SvgText x={290} y={414} size={20} color="var(--ink-soft)" start={7.4}>(protocol-operated)</SvgText>
            <Bubble x={210} y={130} w={390} h={140} tail="br" tailLen={56} tailDx={-50} dur={0.05} start={7.7} fontSize={28}>
              “I manage the vault & quote the market.”
            </Bubble>
            {/* fee + yield loop */}
            <Seg start={11.2}>
              <FlowDot p0={[1240, 800]} c={[980, 900]} p1={[710, 700]} start={0} phase={0} label="fee" labelSize={15} color="var(--ink)"></FlowDot>
              <FlowDot p0={[1240, 800]} c={[980, 900]} p1={[710, 700]} start={0} phase={0.5} label="fee" labelSize={15} color="var(--ink)"></FlowDot>
            ...
            <Seg start={12.4}>
              <SvgText x={975} y={935} size={32} font="var(--font-display)" weight={700} start={0}
                plate plateSeed={127}>← fees</SvgText>
              <SvgText x={350} y={935} size={32} font="var(--font-display)" weight={700} color="var(--accent)" start={0.4}
                plate plateSeed={128}>← yield</SvgText>
            </Seg>
          </SceneSvg>
          <HandText x={960} y={56} size={54} align="center" font="var(--font-display)" weight={700}
            start={0.5} rotate={-1}>So Vibe makes it synthetic</HandText>
        </Seg>
        <Highlight start={S + 21.2} end={S + 25.7} size={138}>Long. Short. Leverage. *Yield on ANY asset.*</Highlight>
      </SceneWrap>
    </Sprite>
  );
}
      ...
      <SceneWrap label="S9 closing">
        ...
        <Seg start={0} end={8.4} keepAfter={false}>
          {({ localTime }) => (
            <div style={{ position: 'absolute', inset: 0, opacity: clamp((8.2 - localTime) / 0.4, 0, 1) }}>
              <SceneSvg>
                <SketchButton x={420} y={420} w={250} h={120} label="BUY" start={0.3} seed={111}
                  fill="var(--good-soft)" fontSize={46}></SketchButton>
                <SketchButton x={710} y={420} w={250} h={120} label="SELL" start={0.9} seed={112}
                  ...
                  {({ localTime: lt }) => (
                    <g opacity={clamp(lt / (0.25 * ANIM), 0, 1)}>
                      ...
                      <text x={1240} y={497} textAnchor="middle"
                        style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 46, fill: '#fff' }}>LEND / BORROW</text>
                    </g>
                  )}
                </Seg>
              ...
              <HandText x={960} y={730} size={62} align="center" font="var(--font-display)" weight={700}
                start={5.0} rotate={-1}>a complete market</HandText>
            </div>
          )}
        </Seg>
        ...
        <Seg start={8.6}>
          ...
          <HandText x={960} y={450} size={120} align="center" font="var(--font-brand)" weight={900}
            start={0.9}>Vibe</HandText>
          <HandText x={960} y={635} size={68} align="center" font="var(--font-display)" weight={700}
            start={1.8} rotate={-1}>Making every asset productive.</HandText>
          <Seg start={2.6}>
          ...
          <HandText x={960} y={800} size={27} align="center" start={4.6} color="var(--ink-soft)">
            Trade carefully. Leverage involves risk. Not financial advice.
          </HandText>
        </Seg>
      </SceneWrap>
    </Sprite>
